package com.sokoldev.budgo.common.utils.prefs
...
class PreferenceHelper {
    ...
    fun isPatientUser(): Boolean {
        return preferences.getBoolean(PreferenceKeys.KEY_PREF_IS_PATIENT_USER, false)
    }

    fun setPatientUser(value: Boolean) {
        preferences.edit().putBoolean(PreferenceKeys.KEY_PREF_IS_PATIENT_USER, value).apply()
    }
